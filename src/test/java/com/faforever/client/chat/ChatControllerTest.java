...
public class ChatControllerTest extends AbstractPlainJavaFxTest {
  ...
  public void setUp() throws Exception {
    ...
    when(uiService.loadFxml("theme/private_chat_tab.fxml")).thenReturn(privateChatTabController);
    when(uiService.loadFxml("theme/channel_tab.fxml")).thenReturn(channelTabController);
