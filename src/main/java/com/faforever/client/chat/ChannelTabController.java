...
public class ChannelTabController extends AbstractChatTabController {
  ...
  public void initialize() {
    super.initialize();
    scheduledExecutorService.scheduleWithFixedDelay(this::updateIdleTimes, 0, IDLE_TIME_UPDATE_DELAY, TimeUnit.SECONDS);
  ...
  private void updateIdleTimes() {
    Platform.runLater(() -> userToChatUserControls.values().stream()
        ...
        .forEach(ChatUserItemController::updateIdleTime));
  }
